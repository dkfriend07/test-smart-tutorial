  ...
  <body>
    ...
    <script>
      FHIR.oauth2.authorize({
        'client_id': '<Replace me with your client id>',
...
The client_id is found in the app details page that can be accessed by clicking on the application icon in the [code console](https://code.cerner.com/developer/smart-on-fhir/smart_apps). Copy the client_id into the authorize call and commit the changes back to your repo.
...
The "index.html" file includes a script which calls into the ```extractData``` function in starter_app.js.
...
>starter_app.js - drawVisualization
